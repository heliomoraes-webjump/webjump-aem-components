...
(function ($, CUI) {
  var GROUP = "colorformat",
    ...
    ICON = "textColor",
    PICKER_URL =
      "/apps/ibcmediro/components/richtext/plugins/popovers/color-picker/_cq_dialog.html";
  ...
  var ColorPickerPlugin = new Class({
    ...
    execute: function (id, value, envOptions) {
      ...
      if (
        selection.startOffset === startNode.length &&
      ...
      if (this.ColorPickerDialog) {
        ...
        dialog.$dialog
          ...
          .css("-moz-transform-origin", "0px 0px");
  ...
  var ColorPickerCmd = new Class({
    ...
    execute: function (execDef) {
      var color = execDef.value
          ? execDef.value[PICKER_NAME_IN_POPOVER]
          : undefined,
  ...
  function addDialogTemplate() {
    ...
    var html =
      "<iframe width='500px' height='400px' frameBorder='0' src='" +
      url +
      "'></iframe>";
    ...
    CUI.rte.templates["dlg-" + DIALOG] = CUI.rte.Templates["dlg-" + DIALOG] =
